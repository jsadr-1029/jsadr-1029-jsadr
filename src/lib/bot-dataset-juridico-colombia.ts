...
export const DATASET_JURIDICO_COLOMBIA: ItemEntrenamiento[] = [
  ...
  // =====================================================
  {
    ...
    respuesta: 'El Art. 1551 del Código Civil colombiano (Ley 84 de 1873) define: "Toda obligación consiste en dar, hacer o no hacer alguna cosa". Clasificación: obligaciones de DAR (entregar cosa), HACER (prestar servicio) y NO HACER (abstenerse). En préstamos de dinero, la obligación principal del deudor es DAR (restituir dinero) y del acreedor es DAR (entregar el capital). Esta clasificación determina las acciones judiciales procedentes en caso de incumplimiento.',
