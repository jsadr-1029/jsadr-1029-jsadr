...
export function UserMenu({ currentView, onNavigate }: UserMenuProps) {
  ...
  // FIX (2026-08-09): En móvil/tablet (<1024px) YA NO se renderiza el botón
  // flotante del UserMenu. El usuario accede a TODO (navegación completa,
  // cerrar sesión y cambiar de cuenta) desde el drawer del Sidebar que se
  // abre con el botón hamburguesa superior-izquierdo. Esto evita tener dos
  // menús superpuestos en la parte superior del móvil.
  //
  // Antes había dos botones flotantes en móvil:
  //   - Izquierda: hamburguesa → drawer del Sidebar (solo navegación)
  //   - Derecha: UserMenu → drawer con navegación + logout + change account
  // El usuario reportó que esto era confuso y solo servía para logout/cambiar
  // cuenta. Ahora TODO está consolidado en el drawer del Sidebar.
