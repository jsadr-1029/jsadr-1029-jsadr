...
SINCRONIZACION = [
    {
        ...
        "ultimo_sync": "2026-08-08 03:39 UTC",
        "detalle": "Commit 44b25ad con Excel actualizado + reset unificado de claves (sistema=Js951029*, clientes=4321). HEAD local = origin/main = 44b25ad. Sin archivos pendientes.",
    },
    {
        "plataforma": "Vercel",
        "estado": "✅ Sincronizado",
        ...
        "ultimo_sync": "2026-08-08 03:39 UTC",
        "detalle": "Deploy dpl_76X2uFV2KWGwpe5D99hUn6cYWNTA READY (commit 44b25ad2). Dominios jsadr.com.co + www.jsadr.com.co asignados. Build OK con Turbopack. 13 env vars en producción.",
    },
    {
        "plataforma": "Neon",
        "estado": "✅ Sincronizado",
        ...
        "ultimo_sync": "2026-08-08 03:39 UTC",
        "detalle": "prisma db push OK + reset de claves unificado. 69 tablas, 650+ registros, 7 usuarios (passwordHash=Js951029*, claveHash=Js951029* para ABOGADO), 9 clientes (claveHash=4321). PlataformaSync.ultimoEstado=OK.",
    },
]
